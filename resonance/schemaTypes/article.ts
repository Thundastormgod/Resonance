...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      readOnly: true,
      fields: [
        {name: 'generationModel', title: 'Generation Model', type: 'string'},
        {name: 'factCheckModel', title: 'Fact Check Model', type: 'string'},
        {name: 'biasCheckModel', title: 'Bias Check Model', type: 'string'},
        {name: 'totalTokensUsed', title: 'Total Tokens Used', type: 'number'},
        {name: 'factCheckScore', title: 'Fact Check Score', type: 'number'},
        {name: 'biasScore', title: 'Bias Score', type: 'number'},
        {name: 'sourceUrls', title: 'Source URLs', type: 'array', of: [{type: 'string'}]},
        {name: 'style', title: 'Writing Style', type: 'string'},
